...
if("TRUE" STREQUAL "TRUE")
  set(tl740d_SOURCE_PREFIX /home/ntut-mit/catkin_ws/src/autolabor/src/driver/imu/tl740d)
  set(tl740d_DEVEL_PREFIX /home/ntut-mit/catkin_ws/devel_isolated/tl740d)
  set(tl740d_INSTALL_PREFIX "")
  set(tl740d_PREFIX ${tl740d_DEVEL_PREFIX})
else()
  set(tl740d_SOURCE_PREFIX "")
  set(tl740d_DEVEL_PREFIX "")
  set(tl740d_INSTALL_PREFIX /home/ntut-mit/catkin_ws/install_isolated)
...
if(NOT "/home/ntut-mit/catkin_ws/src/autolabor/src/driver/imu/tl740d/include " STREQUAL " ")
  set(tl740d_INCLUDE_DIRS "")
  set(_include_dirs "/home/ntut-mit/catkin_ws/src/autolabor/src/driver/imu/tl740d/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tl740d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ntut-mit/catkin_ws/src/autolabor/src/driver/imu/tl740d/${idir}'.  ${_report}")
    endif()
